...
export const getCommunitiesByName = async (communityName) => {
    const response = await fetch(
        createApiUrl(API_ENDPOINTS.GET_COMMUNITIES_BY_NAME(communityName)),
        {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
...
export const updateCommunity = async (community) => {
    const response = await fetch(
        createApiUrl(API_ENDPOINTS.UPDATE_COMMUNITY(community.id)),
        {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
